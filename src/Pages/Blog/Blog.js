...
const Blog = () => {
    return (
        <div className='container mx-auto my-12'>
            ...
            <div tabIndex={0} className="collapse collapse-arrow border border-base-300 bg-base-100 rounded-box m-4">
            ...
            <div tabIndex={0} className="collapse collapse-arrow border border-base-300 bg-base-100 rounded-box m-4">
                <div className="collapse-title text-xl font-medium border-2">
